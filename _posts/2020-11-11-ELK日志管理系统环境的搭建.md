...
date:       2020-11-11             
author:     suleo                  
head-im img/post-bg-keybord.jpg    
catalog: true                      
tags:                              
    - 渗透测试   
---  
...
[img](https://github.com/BigTree975/BigTree975.github.io/blob/mast/img/elk/1.jpg)

在图中有一个input输入框，可以在里面填写筛选所需要的关键词；如果没有筛选出结果，也可检查左侧的时间筛选项是否设置正确，默认显示最近十五分钟产生的数据 。
[img](https://github.com/BigTree975/BigTree975.github.io/blob/mast/img/elk/2.jpg)
...
**部署流程：**
[img](https://github.com/BigTree975/BigTree975.github.io/blob/mast/img/elk/3.jpg)
...
[img](https://github.com/BigTree975/BigTree975.github.io/blob/mast/img/elk/4.jpg)
...
[img](https://github.com/BigTree975/BigTree975.github.io/blob/master/img/elk/5.jpg)

- 服务端启动logstash

  `/opt/logstash/bin/logstash -f /opt/conf/logstash.conf --config.reload.automatic`
[img](https://github.com/BigTree975/BigTree975.github.io/blob/master/img/elk/6.jpg)

- 查看kibana，确认ES是否收集到
[img](https://github.com/BigTree975/BigTree975.github.io/blob/master/img/elk/7.jpg)
...
- logstash收集并打印出日志：
[img](https://github.com/BigTree975/BigTree975.github.io/blob/master/img/elk/8.jpg)

- kibana显示：
[img](https://github.com/BigTree975/BigTree975.github.io/blob/master/img/elk/9.jpg)
