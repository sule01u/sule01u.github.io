...
- 测试示例:
  ...
  - get**方式提交web登录**
    ...
    - 创建name.txt,passwd.txt
      ...
      ![img](/Users/shulei/Documents/myblog/img/penetration_img/st_1.png)

    - 请求dvwa登陆页面,鼠标右键选检查,输入用户名密码后,查看请求header,把下面请求的PHPSESSID改为你自己的

       ![img](/Users/shulei/Documents/myblog/img/penetration_img/st_2.png)
...
- 预期结果
  - 返回的结果,填入网站页面
     ...
     ![img](/Users/shulei/Documents/myblog/img/penetration_img/st_3.png)
  
  - 若防护失败,则能返回下面页面 
  
     ![img](/Users/shulei/Documents/myblog/img/penetration_img/st_4.png)
  
  - 若防护成功,则返回“Username and/or password incorrect”.
     
     ![img](/Users/shulei/Documents/myblog/img/penetration_img/st_5.png)
