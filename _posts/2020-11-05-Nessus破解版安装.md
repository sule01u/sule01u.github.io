...
![img](../img/nessus/1.png)

 2. 更新规则库流程图
![img](../img/nessus/2.png)
...
3. 访问nessus
   ...
   ![img](../img/nessus/5.png)
   ![img](../img/nessus/6.png)

4. 现在会要求新建账号，自己记住账号密码
   ![img](../img/nessus/7.png)

5. 等待初始化完成。完成后登陆进去是没有扫描界面的。
   ![img](../img/nessus/8.png)
